...
<body>
    <div class="container px-4 px-lg-5 jumbotron">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            <div class="col-lg-7">
                <img class="img-fluid rounded mb-4 mb-lg-0" src="/imagen/icons/logo-vectorizado.jpg" alt="..." />
            </div>
            <div class="col-lg-5">          
                <h1 class="font-weight-light">El Pueblito de Don Luis</h1>
                <p>Somos el único hotel de la zona que ofrece el servicio de triple lavado (incluyendo lavado a mano) en cada una de las prendas usadas en nuestras habitaciones.</p>
                <br>
