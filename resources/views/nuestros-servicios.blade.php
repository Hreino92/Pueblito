...
<body>
    <!-- Content Row-->
    <div class="row gx-4 gx-lg-5 jumbotron">
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <img class="card-img-top" src="/imagen/wedding.jpg" alt="Card image cap">
                <div class="card-body">
                    <h2 class="card-title">Bodas</h2>
                ...
                <div class="card-footer text-center"><a class="btn btn-success btn-sm" href="https://wa.link/hh73sc"
                        ...
                        </svg> <br> Contáctanos</a></div>
            </div>
        </div>
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <img class="card-img-top" src="/imagen/cumpleanos.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <img class="card-img-top" src="/imagen/baby.jpg" alt="Card image cap">
                <div class="card-body">
    ...
    <div class="row gx-4 gx-lg-5 jumbotron">
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <img class="card-img-top" src="/imagen/fifteen.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h2 class="card-title">Bautizos</h2>
        ...
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <img class="card-img-top" src="/imagen/events.jpg"  alt="Card image cap">
                <div class="card-body">
